import {hideNativeLoadingToast, showNativeErrorToastIOS, showNativeLoadingToast} from "./NativeMethodUtil";
import {Platform} from 'react-native'
import {isEmpty} from "./StringUtil";
import {transferToZawgyiIfNeeded} from './LanguageUtil';
import {getApiDomain} from "../config/AppConfig";
 ...
 */
const get = function(method, params = {}, showLoading = false, showError = false, loadingDelay = 0, loadingText, transferToZawgyi = true) {
    return request('GET', method, params, showLoading, showError, loadingDelay, loadingText, transferToZawgyi);
}

///post请求 参数和上面一致
const post = function(method, params = {}, showLoading = false, showError = false, loadingDelay = 0, loadingText, transferToZawgyi = true) {
...
function request(httpMethod, method, params = {}, showLoading = false, showError = false, loadingDelay = 0, loadingText, transferToZawgyi = true) {
    ...
    let body = '';
    let requestURL = getApiDomain() + "/api/" + method;
            ...
            try{
                ...
                if (data == null || typeof data !== 'object') {
                    ...
                    if (data.code === 200) {
                        ...
                        //接口报错
                        let message = data.datas ? data.datas.error : null;
